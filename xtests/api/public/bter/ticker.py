...
"""
This file implements test cases for validation communication with REST endpoint on Bter. This endpoint offer tick informations.
"""
...
def schema():
    return ccs.bter.configuration.SCHEMA["ticker"]
