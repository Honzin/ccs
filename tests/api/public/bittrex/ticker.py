...
"""
This file implements test cases for validation communication with REST endpoint on Bittrex. This endpoint offer tick informations.
"""
...
def schema():
    return ccs.bittrex.configuration.SCHEMA["getTicker"]
