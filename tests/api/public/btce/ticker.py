...
"""
This file implements test cases for validation communication with REST endpoint on Btce. This endpoint offer tick informations.
"""
...
def schema():
    return ccs.btce.configuration.SCHEMA["ticker"]
