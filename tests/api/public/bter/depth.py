...
"""
This file implements test cases for validation communication with REST endpoint on Bter. This endpoint offer informations about orderbook.
"""
...
def schema():
    return ccs.bter.configuration.SCHEMA["depth"]
